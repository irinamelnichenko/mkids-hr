...
| | |
|---|---|
| Версія у репозиторії | **v7.254** |
| md5 | `54178c54e678ac8d73e682187146561d` |
| Розмір | 1703411 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.253** — v7.254 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.254` після деплою |
