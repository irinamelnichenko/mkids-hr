...
| | |
|---|---|
| Версія у репозиторії | **v7.208** |
| md5 | `b4eaf3944982b4bf361d408652533bae` |
| Розмір | 1540094 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.205** — v7.208 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.208` після деплою |
