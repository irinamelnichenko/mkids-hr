...
| | |
|---|---|
| Версія у репозиторії | **v7.179** |
| md5 | `23025cfab35796f77a720df0e89a63d6` |
| Розмір | 1438332 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.179 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.179` після деплою |
