...
| | |
|---|---|
| Версія у репозиторії | **v7.156** |
| md5 | `d121438d9442307e497f8a1e9a78f8f7` |
| Розмір | 1294912 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.150** — v7.156 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.156` після деплою |
...
4. Перевірити `ТГ_Директори`: локації без запису тепер видно в картці
   рядком «⚠️ Відповідальну не призначено».
