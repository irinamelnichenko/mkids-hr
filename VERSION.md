...
| | |
|---|---|
| Версія у репозиторії | **v7.165** |
| md5 | `d60e1a2adc7812e70524d174f772b404` |
| Розмір | 1366835 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.165 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.165` після деплою |
