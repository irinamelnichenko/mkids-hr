...
| | |
|---|---|
| Версія у репозиторії | **v7.190** |
| md5 | `3c12fa08022750370a1ab12eb6b1db41` |
| Розмір | 1475930 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.184** — v7.185…v7.190 ЩЕ НЕ ЗАДЕПЛОЄНО (перевірено ping 2026-08-30) |
| Перевірка | `action=ping` → має стати `pong v7.190` після деплою |
