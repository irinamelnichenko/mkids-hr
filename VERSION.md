...
| | |
|---|---|
| Версія у репозиторії | **v7.155** |
| md5 | `1146afb8518f7d1f3f9c61b933850ade` |
| Розмір | 1288823 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.150** — v7.155 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.155` після деплою |
...
4. `REPAIR_LEAD_CONFLICTS()` → `..._APPLY()` — почистити картки, де вже
