...
| | |
|---|---|
| Версія у репозиторії | **v7.245** |
| md5 | `07dd4d2a6e699a2fc79aa031b3eb7a3b` |
| Розмір | 1642386 байт |
| Зафіксовано | 2026-09-04 |
| Версія у проді | **v7.236** — v7.245 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.245` після деплою |
