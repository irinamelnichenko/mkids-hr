...
| | |
|---|---|
| Версія у репозиторії | **v7.255** |
| md5 | `21a213069b48bca7eab448c8bfdc1148` |
| Розмір | 1705215 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.254** — v7.255 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.255` після деплою |
