...
| | |
|---|---|
| Версія у репозиторії | **v7.212** |
| md5 | `8d1ac9f74013f3f62cf22be61188389d` |
| Розмір | 1558705 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.210** — v7.211/v7.212 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.212` після деплою |
