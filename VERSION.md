...
| | |
|---|---|
| Версія у репозиторії | **v7.267** |
| md5 | `32e0daa439fda50c65cee42d9534dcee` |
| Розмір | 1781791 байт |
| Зафіксовано | 2026-09-08 |
| Версія у проді | **v7.265** — задеплоєно 08.09.2026; v7.266+v7.267 очікують деплою |
| Перевірка | `action=ping` → `pong v7.267` після деплою |
