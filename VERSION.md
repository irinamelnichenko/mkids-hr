...
| | |
|---|---|
| Версія у репозиторії | **v7.233** |
| md5 | `e40d5f0c584c6aed7771163f23f7e79b` |
| Розмір | 1611323 байт |
| Зафіксовано | 2026-09-03 |
| Версія у проді | **v7.232** — v7.233 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.233` після деплою |
