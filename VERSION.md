...
| | |
|---|---|
| Версія у репозиторії | **v7.211** |
| md5 | `45998bd56c90d382f318e6bac6c19642` |
| Розмір | 1557015 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.210** — v7.211 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.211` після деплою |
