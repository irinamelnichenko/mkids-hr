...
| | |
|---|---|
| Версія у репозиторії | **v7.173** |
| md5 | `a20b86ed847a8f376b5320f0a418657e` |
| Розмір | 1409661 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.173 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.173` після деплою |
