...
| | |
|---|---|
| Версія у репозиторії | **v7.178** |
| md5 | `87b45047ec0927b986f219e7c190edf8` |
| Розмір | 1422834 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.178 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.178` після деплою |
