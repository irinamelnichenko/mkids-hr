...
| | |
|---|---|
| Версія у репозиторії | **v7.162** |
| md5 | `82490c97fe8433e241e9788f66240867` |
| Розмір | 1339634 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.162 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.162` після деплою |
