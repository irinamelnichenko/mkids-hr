...
| | |
|---|---|
| Версія у репозиторії | **v7.203** |
| md5 | `fc1597a394ae70defc5beeb68bea193b` |
| Розмір | 1533874 байт |
| Зафіксовано | 2026-09-01 |
| Версія у проді | **v7.202** — v7.203 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.203` після деплою |
