...
| | |
|---|---|
| Версія у репозиторії | **v7.250** |
| md5 | `34451edb0e84c34d0d5eac3061088b90` |
| Розмір | 1655451 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.248** — v7.249/v7.250 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.250` після деплою |
