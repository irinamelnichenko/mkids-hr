...
| | |
|---|---|
| Версія у репозиторії | **v7.199** |
| md5 | `f62de6f28c97d1057d7e878426a01ea3` |
| Розмір | 1518145 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.193** — задеплоєно 2026-08-30; v7.195–v7.199 ЩЕ НЕ ЗАДЕПЛОЄНО (у проді v7.194) |
| Перевірка | `action=ping` → має стати `pong v7.199` після деплою |
