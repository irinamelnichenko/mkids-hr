...
| | |
|---|---|
| Версія у репозиторії | **v7.202** |
| md5 | `665dfd6a55bb8f488779a971fd2c5489` |
| Розмір | 1533242 байт |
| Зафіксовано | 2026-09-01 |
| Версія у проді | **v7.200** — v7.202 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.202` після деплою |
