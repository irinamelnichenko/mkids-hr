...
| | |
|---|---|
| Версія у репозиторії | **v7.257** |
| md5 | `8dae4fd70a26430d10fb85e929ee8f0e` |
| Розмір | 1719001 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.256** — v7.257 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.257` після деплою |
