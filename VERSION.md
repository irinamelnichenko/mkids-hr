...
| | |
|---|---|
| Версія у репозиторії | **v7.175** |
| md5 | `f1826cfcc3fc111d87ee1e22aec961ae` |
| Розмір | 1412884 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.175 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.175` після деплою |
