...
| | |
|---|---|
| Версія у репозиторії | **v7.180** |
| md5 | `140ada74687e33040af1620bd8063eef` |
| Розмір | 1441808 байт |
| Зафіксовано | 2026-08-23 |
| Версія у проді | **v7.179** — v7.180 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.180` після деплою |
