...
| | |
|---|---|
| Версія у репозиторії | **v7.172** |
| md5 | `870efd5b31a5307cf25cb4dc32a8e9e0` |
| Розмір | 1409337 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.172 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.172` після деплою |
