...
| | |
|---|---|
| Версія у репозиторії | **v7.205** |
| md5 | `2b5f4fa11211fbbdbfc0b37d2fc6cdf9` |
| Розмір | 1537833 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.203** — v7.205 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.205` після деплою |
