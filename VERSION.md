...
| | |
|---|---|
| Версія у репозиторії | **v7.224** |
| md5 | `48f23234a96605df436efcae11d1d197` |
| Розмір | 1581869 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.223** — v7.224 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.224` після деплою |
