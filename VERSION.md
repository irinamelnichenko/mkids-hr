...
| | |
|---|---|
| Версія у репозиторії | **v7.170** |
| md5 | `b7a908966542a9128f74ca9915fa75a0` |
| Розмір | 1400711 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.170 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.170` після деплою |
