...
| | |
|---|---|
| Версія у репозиторії | **v7.265** |
| md5 | `91fe9111f6a92265506d5bf3ccf72cda` |
| Розмір | 1773798 байт |
| Зафіксовано | 2026-09-08 |
| Версія у проді | **v7.264** — задеплоєно 08.09.2026; v7.265 очікує деплою |
| Перевірка | `action=ping` → `pong v7.265` після деплою |
