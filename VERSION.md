...
| | |
|---|---|
| Версія у репозиторії | **v7.197** |
| md5 | `9bd9e65741ebddd8c1420b365e26c144` |
| Розмір | 1507802 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.193** — задеплоєно 2026-08-30; v7.194–v7.197 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.197` після деплою |
