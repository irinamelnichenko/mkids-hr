...
| | |
|---|---|
| Версія у репозиторії | **v7.184** |
| md5 | `d865328d18ff495bc655e4e1f6889f57` |
| Розмір | 1452673 байт |
| Зафіксовано | 2026-08-23 |
| Версія у проді | **v7.183** — v7.184 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.184` після деплою |
