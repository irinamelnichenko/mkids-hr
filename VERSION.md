...
| | |
|---|---|
| Версія у репозиторії | **v7.248** |
| md5 | `e3e18f80c3a494bf4e3e3c204108d741` |
| Розмір | 1651188 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.246** — v7.248 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.248` після деплою |
