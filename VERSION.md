...
| | |
|---|---|
| Версія у репозиторії | **v7.266** |
| md5 | `71feefadc321e504426eed77664a1f06` |
| Розмір | 1777979 байт |
| Зафіксовано | 2026-09-08 |
| Версія у проді | **v7.265** — задеплоєно 08.09.2026; v7.266 очікує деплою |
| Перевірка | `action=ping` → `pong v7.266` після деплою |
