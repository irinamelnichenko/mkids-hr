...
| | |
|---|---|
| Версія у репозиторії | **v7.195** |
| md5 | `caf95e1b0ee884c3e6d829f1923b7fca` |
| Розмір | 1502784 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.193** — задеплоєно 2026-08-30; v7.194–v7.195 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.195` після деплою |
