...
| | |
|---|---|
| Версія у репозиторії | **v7.263** |
| md5 | `d35b7ef5d8ab69a6a127268617f74b67` |
| Розмір | 1752278 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.262** — v7.263 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.263` після деплою |
