...
| | |
|---|---|
| Версія у репозиторії | **v7.227** |
| md5 | `b4356ea8c82501bb2ea5edd5a66ee0e4` |
| Розмір | 1585886 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.225** — v7.227 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.227` після деплою |
