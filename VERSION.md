...
| | |
|---|---|
| Версія у репозиторії | **v7.218** |
| md5 | `6804e1b56a9633ae65fe7bd6e56f798c` |
| Розмір | 1566024 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.217** — v7.218 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.218` після деплою |
