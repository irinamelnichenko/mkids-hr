...
| | |
|---|---|
| Версія у репозиторії | **v7.251** |
| md5 | `32527571c1f137c1ffba755706ad7323` |
| Розмір | 1660924 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.248** — v7.249/250/251 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.251` після деплою |
