...
| | |
|---|---|
| Версія у репозиторії | **v7.262** |
| md5 | `7ff8fc11cc5f4bfea77ea7b90e98b992` |
| Розмір | 1750536 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.261** — v7.262 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.262` після деплою |
