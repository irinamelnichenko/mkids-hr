...
| | |
|---|---|
| Версія у репозиторії | **v7.234** |
| md5 | `71dfd51ec4057869d8322fc541003042` |
| Розмір | 1620290 байт |
| Зафіксовано | 2026-09-03 |
| Версія у проді | **v7.233** — v7.234 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.234` після деплою |
