...
| | |
|---|---|
| Версія у репозиторії | **v7.154** |
| md5 | `6872b14b6434b87b22877325e1a5ce15` |
| Розмір | 1282189 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.150** — v7.154 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.154` після деплою |
