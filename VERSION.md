...
| | |
|---|---|
| Версія у репозиторії | **v7.249** |
| md5 | `763ca807f2e446961ce6342f7f464f22` |
| Розмір | 1652427 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.248** — v7.249 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.249` після деплою |
