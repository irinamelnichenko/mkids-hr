...
| | |
|---|---|
| Версія у репозиторії | **v7.221** |
| md5 | `06e9db8c03c65d2f40ff4b2360b04bd6` |
| Розмір | 1574733 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.220** — v7.221 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.221` після деплою |
