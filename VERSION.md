...
| | |
|---|---|
| Версія у репозиторії | **v7.181** |
| md5 | `25e471fa843b23234a0feca75d143ac8` |
| Розмір | 1445027 байт |
| Зафіксовано | 2026-08-23 |
| Версія у проді | **v7.180** — v7.181 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.181` після деплою |
