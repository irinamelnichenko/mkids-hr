...
| | |
|---|---|
| Версія у репозиторії | **v7.191** |
| md5 | `5faf5ba1acd51cef353ee6580ece93b3` |
| Розмір | 1484846 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.184** — v7.185…v7.191 ЩЕ НЕ ЗАДЕПЛОЄНО (перевірено ping 2026-08-30) |
| Перевірка | `action=ping` → має стати `pong v7.191` після деплою |
