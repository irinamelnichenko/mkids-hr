...
| | |
|---|---|
| Версія у репозиторії | **v7.174** |
| md5 | `b6a986d6e63e2c5c56e5a4a46b74efe0` |
| Розмір | 1411095 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.174 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.174` після деплою |
