...
| | |
|---|---|
| Версія у репозиторії | **v7.252** |
| md5 | `58ecf21d1039630c6ec4d365b2e42e96` |
| Розмір | 1672349 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.251** — v7.252 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.252` після деплою |
