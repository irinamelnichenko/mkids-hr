...
| | |
|---|---|
| Версія у репозиторії | **v7.264** |
| md5 | `f3925f14f6bc19db895c9cf3450d0fab` |
| Розмір | 1757646 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.263** — v7.264 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.264` після деплою |
