...
| | |
|---|---|
| Версія у репозиторії | **v7.219** |
| md5 | `bc86a12252e8f49c69f07d53242b2ca8` |
| Розмір | 1566109 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.218** — v7.219 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.219` після деплою |
