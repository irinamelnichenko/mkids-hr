...
| | |
|---|---|
| Версія у репозиторії | **v7.261** |
| md5 | `7501f29febe0190f25b1a2d039ef911c` |
| Розмір | 1735805 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.260** — v7.261 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.261` після деплою |
