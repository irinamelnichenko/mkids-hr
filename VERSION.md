...
| | |
|---|---|
| Версія у репозиторії | **v7.256** |
| md5 | `804b69eb1c5ca34cd8c4f3f87b9766b6` |
| Розмір | 1715673 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.255** — v7.256 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.256` після деплою |
