...
| | |
|---|---|
| Версія у репозиторії | **v7.235** |
| md5 | `52198f8d7f04df555ed52ccd52f08109` |
| Розмір | 1623503 байт |
| Зафіксовано | 2026-09-03 |
| Версія у проді | **v7.234** — v7.235 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.235` після деплою |
