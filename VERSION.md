...
| | |
|---|---|
| Версія у репозиторії | **v7.222** |
| md5 | `8768e0654f55cfe331b23acf0f12a9ee` |
| Розмір | 1579296 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.221** — v7.222 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.222` після деплою |
