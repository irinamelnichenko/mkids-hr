...
| | |
|---|---|
| Версія у репозиторії | **v7.185** |
| md5 | `d3548137bd0dab00b909406ee9d2028b` |
| Розмір | 1454595 байт |
| Зафіксовано | 2026-08-23 |
| Версія у проді | **v7.184** — v7.185 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.185` після деплою |
