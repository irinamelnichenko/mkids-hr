...
| | |
|---|---|
| Версія у репозиторії | **v7.192** |
| md5 | `970cab86d85532267558e929b7cebf2a` |
| Розмір | 1489854 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.184** — v7.185…v7.192 ЩЕ НЕ ЗАДЕПЛОЄНО (перевірено ping 2026-08-30) |
| Перевірка | `action=ping` → має стати `pong v7.192` після деплою |
