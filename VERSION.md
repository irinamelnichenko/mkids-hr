...
| | |
|---|---|
| Версія у репозиторії | **v7.159** |
| md5 | `0fd47a1f234a7839da2d449622f4d1a9` |
| Розмір | 1330354 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.150** — v7.159 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.159` після деплою |
