...
| | |
|---|---|
| Версія у репозиторії | **v7.236** |
| md5 | `5d7c7d406f3a4afddc588bc21e524a38` |
| Розмір | 1638921 байт |
| Зафіксовано | 2026-09-04 |
| Версія у проді | **v7.235** — v7.236 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.236` після деплою |
