...
| | |
|---|---|
| Версія у репозиторії | **v7.209** |
| md5 | `1087140ad3a240ac3a984228edfa11bb` |
| Розмір | 1554833 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.205** — v7.208/v7.209 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.209` після деплою |
