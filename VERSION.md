...
| | |
|---|---|
| Версія у репозиторії | **v7.182** |
| md5 | `a2c2262db25f4a1d119832e261283f51` |
| Розмір | 1448293 байт |
| Зафіксовано | 2026-08-23 |
| Версія у проді | **v7.181** — v7.182 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.182` після деплою |
