...
| | |
|---|---|
| Версія у репозиторії | **v7.230** |
| md5 | `0208fa6399dc9a0b3a8456f99dae66e1` |
| Розмір | 1592330 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.227** — v7.228/v7.230 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.230` після деплою |
