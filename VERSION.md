...
| | |
|---|---|
| Версія у репозиторії | **v7.217** |
| md5 | `8c69bea15ab874a0085c3ceabdf57834` |
| Розмір | 1565108 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.210** — v7.211/v7.212/v7.217 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.217` після деплою |
