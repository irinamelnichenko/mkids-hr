...
| | |
|---|---|
| Версія у репозиторії | **v7.183** |
| md5 | `acef2834cb84b32ad256440e27085758` |
| Розмір | 1450975 байт |
| Зафіксовано | 2026-08-23 |
| Версія у проді | **v7.182** — v7.183 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.183` після деплою |
