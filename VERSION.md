...
| | |
|---|---|
| Версія у репозиторії | **v7.231** |
| md5 | `476ccf2249f323e0f9d457e237ea322b` |
| Розмір | 1600409 байт |
| Зафіксовано | 2026-09-03 |
| Версія у проді | **v7.230** — v7.231 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.231` після деплою |
