...
| | |
|---|---|
| Версія у репозиторії | **v7.200** |
| md5 | `b64e9421cf6c8765e2d2339f3b1b7e16` |
| Розмір | 1531929 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.193** — задеплоєно 2026-08-30; v7.195–v7.200 ЩЕ НЕ ЗАДЕПЛОЄНО (у проді v7.194) |
| Перевірка | `action=ping` → має стати `pong v7.200` після деплою |
