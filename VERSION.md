...
| | |
|---|---|
| Версія у репозиторії | **v7.253** |
| md5 | `8a4af9ffa2c1ffbb729dc864a642493f` |
| Розмір | 1690489 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.252** — v7.253 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.253` після деплою |
