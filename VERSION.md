...
| | |
|---|---|
| Версія у репозиторії | **v7.225** |
| md5 | `40c5a05d5f7ea9a67fdc8e046ca6a356` |
| Розмір | 1582181 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.224** — v7.225 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.225` після деплою |
