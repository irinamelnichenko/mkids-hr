...
| | |
|---|---|
| Версія у репозиторії | **v7.157** |
| md5 | `9757d44418cab6b675a797965e16632a` |
| Розмір | 1301349 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.150** — v7.157 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.157` після деплою |
