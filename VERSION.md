...
| | |
|---|---|
| Версія у репозиторії | **v7.198** |
| md5 | `ee8ec86e82a61a8383a3e99781d1a77a` |
| Розмір | 1510661 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.193** — задеплоєно 2026-08-30; v7.195–v7.198 ЩЕ НЕ ЗАДЕПЛОЄНО (у проді v7.194) |
| Перевірка | `action=ping` → має стати `pong v7.198` після деплою |
