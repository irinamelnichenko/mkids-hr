...
| | |
|---|---|
| Версія у репозиторії | **v7.171** |
| md5 | `4536b52c2a09e9cf6903b879585d1e9c` |
| Розмір | 1403576 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.171 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.171` після деплою |
