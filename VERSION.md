...
| | |
|---|---|
| Версія у репозиторії | **v7.220** |
| md5 | `7305291dd93e1b7059c5ece2e3c37da6` |
| Розмір | 1571280 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.219** — v7.220 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.220` після деплою |
