...
| | |
|---|---|
| Версія у репозиторії | **v7.164** |
| md5 | `498b23a764546aa10b38192444c72728` |
| Розмір | 1358513 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.164 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.164` після деплою |
