...
| | |
|---|---|
| Версія у репозиторії | **v7.167** |
| md5 | `c3cd346d13844bcaabfddabca2a0e29d` |
| Розмір | 1378089 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.167 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.167` після деплою |
