...
| | |
|---|---|
| Версія у репозиторії | **v7.189** |
| md5 | `87776a5415346291a985035e2e0d2629` |
| Розмір | 1463885 байт |
| Зафіксовано | 2026-08-28 |
| Версія у проді | **v7.184** — v7.185…v7.189 ЩЕ НЕ ЗАДЕПЛОЄНО (перевірено ping 2026-08-28) |
| Перевірка | `action=ping` → має стати `pong v7.189` після деплою |
