...
| | |
|---|---|
| Версія у репозиторії | **v7.193** |
| md5 | `15e30b3f5ada6d4fdf3986a530d3e21d` |
| Розмір | 1490202 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.184** — v7.185…v7.193 ЩЕ НЕ ЗАДЕПЛОЄНО (перевірено ping 2026-08-30) |
| Перевірка | `action=ping` → має стати `pong v7.193` після деплою |
