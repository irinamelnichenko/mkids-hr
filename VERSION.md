...
| | |
|---|---|
| Версія у репозиторії | **v7.187** |
| md5 | `f82b3cb5ac2ac6d96a58795b18383358` |
| Розмір | 1455431 байт |
| Зафіксовано | 2026-08-28 |
| Версія у проді | **v7.184** — v7.185/v7.186/v7.187 ЩЕ НЕ ЗАДЕПЛОЄНО (перевірено ping 2026-08-28) |
| Перевірка | `action=ping` → має стати `pong v7.187` після деплою |
