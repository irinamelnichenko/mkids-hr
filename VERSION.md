...
| | |
|---|---|
| Версія у репозиторії | **v7.232** |
| md5 | `51fbfe9aabc5417e34e8f649c761259b` |
| Розмір | 1602982 байт |
| Зафіксовано | 2026-09-03 |
| Версія у проді | **v7.231** — v7.232 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.232` після деплою |
