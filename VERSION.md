...
| | |
|---|---|
| Версія у репозиторії | **v7.260** |
| md5 | `9be124cf8b57037a3e9873b71e815e97` |
| Розмір | 1732245 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.259** — v7.260 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.260` після деплою |
