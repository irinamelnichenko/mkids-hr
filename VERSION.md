...
| | |
|---|---|
| Версія у репозиторії | **v7.246** |
| md5 | `ba14ebc0a5d1fcca36ad728dca7546c3` |
| Розмір | 1644851 байт |
| Зафіксовано | 2026-09-04 |
| Версія у проді | **v7.245** — v7.246 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.246` після деплою |
