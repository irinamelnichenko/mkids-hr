...
| | |
|---|---|
| Версія у репозиторії | **v7.188** |
| md5 | `dd34434d226ee02d16b023281d41211a` |
| Розмір | 1462726 байт |
| Зафіксовано | 2026-08-28 |
| Версія у проді | **v7.184** — v7.185…v7.188 ЩЕ НЕ ЗАДЕПЛОЄНО (перевірено ping 2026-08-28) |
| Перевірка | `action=ping` → має стати `pong v7.188` після деплою |
