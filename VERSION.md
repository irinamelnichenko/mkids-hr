...
| | |
|---|---|
| Версія у репозиторії | **v7.196** |
| md5 | `6e11f35c2ab5b85211907c290af7b8a3` |
| Розмір | 1504276 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.193** — задеплоєно 2026-08-30; v7.194–v7.196 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.196` після деплою |
