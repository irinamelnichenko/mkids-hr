...
| | |
|---|---|
| Версія у репозиторії | **v7.194** |
| md5 | `1d97e27c696cd869b49262eba28bfb01` |
| Розмір | 1495286 байт |
| Зафіксовано | 2026-08-30 |
| Версія у проді | **v7.193** — задеплоєно 2026-08-30; v7.194 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.194` після деплою |
