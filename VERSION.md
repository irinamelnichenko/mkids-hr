...
| | |
|---|---|
| Версія у репозиторії | **v7.166** |
| md5 | `25090b8f02b5675dccea8aae9220553a` |
| Розмір | 1377959 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.166 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.166` після деплою |
