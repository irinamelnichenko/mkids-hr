...
| | |
|---|---|
| Версія у репозиторії | **v7.259** |
| md5 | `faaf948f455aa08dfc2702c55a52fc40` |
| Розмір | 1729255 байт |
| Зафіксовано | 2026-09-06 |
| Версія у проді | **v7.257** — v7.259 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.259` після деплою |
