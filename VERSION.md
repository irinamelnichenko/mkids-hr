...
| | |
|---|---|
| Версія у репозиторії | **v7.223** |
| md5 | `b00c277d6654a6de4f5737c2592ce496` |
| Розмір | 1579353 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.222** — v7.223 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.223` після деплою |
