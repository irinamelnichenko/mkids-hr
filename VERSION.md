...
| | |
|---|---|
| Версія у репозиторії | **v7.210** |
| md5 | `ea1655a452b2adeda0263bb433384e73` |
| Розмір | 1555682 байт |
| Зафіксовано | 2026-09-02 |
| Версія у проді | **v7.209** — ⚠️ ТЕРМІНОВО ЗАМІНИТИ на v7.210 (див. нижче) |
| Перевірка | `action=ping` → має стати `pong v7.210` після деплою |
