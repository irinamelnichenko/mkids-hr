...
| | |
|---|---|
| Версія у репозиторії | **v7.169** |
| md5 | `0feb3af828db602eb14163bf7fbd067e` |
| Розмір | 1399127 байт |
| Зафіксовано | 2026-08-19 |
| Версія у проді | **v7.160** — v7.169 ЩЕ НЕ ЗАДЕПЛОЄНО |
| Перевірка | `action=ping` → має стати `pong v7.169` після деплою |
...
`SETUP_AD_SPEND_SHEET()` — створює аркуш «Реклама_Витрати» в CONFIG
